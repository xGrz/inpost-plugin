...
abstract class InPostTestCase extends TestCase
{
    ...
    public function fakeSendingMethodsResponse(): array
    {
        return ['*' => Http::response(self::fromFile('SendingMethodsResponse.json'))];
    }

    public function fakePointsResponse(): array
    {
